...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-WDRxSwiftDemo/ObjectMapper.framework"
  install_framework "Pods-WDRxSwiftDemo/RxAlamofire.framework"
  install_framework "Pods-WDRxSwiftDemo/RxBlocking.framework"
